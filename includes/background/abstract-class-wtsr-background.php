...
if ( ! class_exists( 'WP_Async_Request', false ) ) {
    include_once plugin_dir_path( WTSR_PLUGIN_FILE ) . 'vendor/wp-background-processing/classes/wp-async-request.php';
}

if ( ! class_exists( 'WP_Background_Process', false ) ) {
    include_once plugin_dir_path( WTSR_PLUGIN_FILE ) . 'vendor/wp-background-processing/classes/wp-background-process.php';
}

abstract class Wtsr_Background_Process extends WP_Background_Process {
