...
class Wtsr_Background_Review_Request_Process extends Wtsr_Background_Process {
    use Wtsr_Logger;
    ...
    public function __construct() {
        $this->action = 'wtsr_review_request';
    ...
    protected function handle() {
        ...
        do {
            ...
            foreach ( $batch->data as $key => $value ) {
                $transfer_data = $this->bg_task($value);
    ...
    protected function bg_task($value) {
        usleep(20000);
        TSManager::create_new_review_item($value[0]);
